...
class PSTextField: UITextField {
    ...
    func addErrorInfoDisclosure(){
        ...
        infoDisclosure.transform = CGAffineTransform(rotationAngle: CGFloat(M_PI))
    ...
    func displayErrorAlert(){
        ...
        let popupViewTriangleTopTipPoint: CGPoint = CGPoint(x: self.frame.size.width-popUpTriangleHorizontalRightMargin,
